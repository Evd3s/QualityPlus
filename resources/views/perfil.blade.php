        ...
        <div class="company-card" id="company-card">
            ...
            <div id="has-company" class="hidden">
                <div class="company-image">
                    <img src="{{ asset('images/empresa-default.png') }}" alt="Empresa">
                </div>
                <div class="company-name" id="company-name-display">
                    Nome da Empresa
                </div>
                <div class="company-buttons">
                    <a href="{{ route('empresa.create') }}" class="edit-company-button">
                        Editar Empresa
                    </a>
            ...
            <div id="no-company" class="">
                <div class="no-company-state">
                    ...
                    <a href="{{ route('empresa.create') }}" class="create-company-button-center">
                        Criar Empresa
                    </a>
                </div>
            </div>
