<?php $__env->startSection('title', 'Mapa de Lojas'); ?>

<?php $__env->startSection('content'); ?>
<!-- Manter seu cabeçalho original -->
<header class="profile-header">
    ...
    <div class="profile-section">
        <a href="<?php echo e(route('perfil')); ?>">
            <img src="<?php echo e(auth()->user()->profile_image ? asset('storage/' . auth()->user()->profile_image) . '?t=' . uniqid() : asset('images/Perfil.png')); ?>" alt="Mini Perfil" class="header-profile-image" id="header-profile-image">
        </a>
    </div>
</header>
...
<script src="<?php echo e(asset('js/lojas-map.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Inaldo Pontes\Desktop\QualityPlus-main\resources\views/lojas-mapa.blade.php ENDPATH**/ ?>