...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                <!-- Removido o "Home" -->
                <li><a href="<?php echo e(route('login')); ?>" class="btn-header">Entrar</a></li>
            </ul>
        </nav>
    </header>
    ...
    <section class="hero">
        <div class="content-box">
            ...
            <div class="buttons">
                <a href="<?php echo e(route('login')); ?>" class="btn-primary">Entrar</a>
                <a href="#" class="btn-secondary">Mais</a>
            </div>
        </div>
        <div class="image-box">
            <img src="<?php echo e(asset('images/business.png')); ?>" alt="Ilustração de negócios">
        </div>
    </section>

    <!-- Rodapé personalizado -->
    <footer style="background: linear-gradient(to right, #006BE6, #0052cc); color: #fff; padding: 20px; text-align: center;">
        <p>&copy; <?php echo e(date('Y')); ?> QualityPlus. Todos os direitos reservados.</p>
    </footer>

</body>
</html>
<?php /**PATH C:\Users\Inaldo Pontes\Desktop\QualityPlus-main\resources\views/home.blade.php ENDPATH**/ ?>